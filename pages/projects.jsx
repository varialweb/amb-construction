...
export default function ProjectsPage() {
  return (
    <StandardPageLayout>
      <Head>
        <title>Builds That Last a Lifetime</title>
        <meta name="description" content="AMB construction is built to last. Your new build for residential, commercial, and rural development is a top priority from the moment AMB sees your blueprint. Explore our portfolio of projects to see how your new build will stand out and stand the test of time with our team." />
      </Head>
