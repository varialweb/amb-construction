    ...
    <StandardPageLayout text="white">
      ...
      <section className="py-12 px-5 grid gap-8 lg:hidden">
        ...
        <div className="flex mx-auto lg:justify-between lg:max-w-[40vw]">
          ...
          <Polaroid src={{ mobile: '/img/harrilyn-young.png', pc: '/img/harrilyn-young.png' }} sizes={{ mobile: 150, pc: 50 }} className="rotate-[17.98deg] relative right-6 w-full lg:w-[150px]" />
        </div>
        <p>
      ...
      <section className="py-12 px-5 lg:px-[128px] lg:py-24">
        ...
        <div className="hidden lg:grid grid-cols-2 items-center justify-center">
          ...
          <div className="mx-auto justify-self-center grid justify-center w-full">
            <img src="/img/stock-project.png" className="rounded shadow-inner max-w-[600px]" />
          </div>
        </div>
      </section>
      <section className="px-5 py-12 bg-gradient-to-b from-[#0070C4] to-[#5A9CD7]">
        <form className="bg-white max-w-[920px] mx-auto p-5 lg:px-16 lg:py-8 grid gap-8 rounded shadow-md">
